...
//   return (
//     <form  onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 dm:pt-14 min-h-[80vh] border-t'>
//       {/**left side */}
  ...
  return (
    ...
    <div className='mt-8'>
      ...
      <div className='mt-12'>
        ...
        {/*-----------------------Payment method selection---------------------- */}
        <div className='flex gap-3 flex-col lg:flex-row'>
          <div onClick={()=>setMethod('stripe')} className='flex items-center gap-3border p-2 px-3 cursor-pointer'>
          ...
          {/* <div onClick={()=>setMethod('razorpay')} className='flex items-center gap-3border p-2 px-3 cursor-pointer'>
          ...
          <div onClick={()=>setMethod('cod')} className='flex items-center gap-3border p-2 px-3 cursor-pointer'>
